    ...
    <div class="row">
        ...
        <div id="share" class = "share col-lg-6">
            ...
            <div class="icon-redes">
                ...
                <a href="https://plus.google.com/u/0/114262602925780408268/posts?hl=es"><img src="https://norfipc.com/img/logos/icon-60-gplus.png" style="padding-top:4px;" width="60" height="60" alt="Compartir en Google+" title="Síguenos en Google+"></a>
            </div>
        </div>
    </div>
    <div class="row">
